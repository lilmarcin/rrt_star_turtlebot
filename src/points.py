...
if __name__ == '__main__':
    ...
    #en = Point(2.5, 0.7, "end", (1.0, 0.0, 0.0))
    st = Point(0.0, 0.0, "start", (0.0, 1.0, 0.0))	#map home
    en = Point(7, 0.7, "end", (1.0, 0.0, 0.0))		#map home
    st = Point(-2.0, -1.0, "start", (0.0, 1.0, 0.0))	#map colloseum
    en = Point(1.5, 0., "end", (1.0, 0.0, 0.0))		#map colloseum
